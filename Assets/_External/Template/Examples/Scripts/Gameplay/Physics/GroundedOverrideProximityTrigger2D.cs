...
{
    /// <summary>
    /// Updates <see cref="PhysicsChecker2D.ForceGroundedState"/> using a <see cref="ForceGroundedStateTallyCounter2D"/> for any <see cref="PhysicsChecker2D"/>s within any triggers on the object.
    /// </summary>
